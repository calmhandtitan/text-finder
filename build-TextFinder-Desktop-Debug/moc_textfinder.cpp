...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TextFinder_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 33, 0)
    ...
    "TextFinder\0on_findButton_clicked\0\0"
};
...
const QMetaObject TextFinder::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TextFinder.data,
      qt_meta_data_TextFinder,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TextFinder.stringdata))
